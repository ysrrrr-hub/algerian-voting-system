    ...
    def verify_receipt(receipt_code):
        try:
            ...
            if record:
                ...
                result = {
                    "verified": True,
                    "receipt_code": record[0],
                    "timestamp": record[1].isoformat() if record[1] else None,
                    "block_hash": record[2],
                    "block_index": record[3],
                    "verified_count": record[4] + 1,
                    "election_name_ar": record[5],
                    "election_name_fr": record[6],
